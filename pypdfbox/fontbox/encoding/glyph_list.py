...
# Keys: PostScript glyph names. Values: the Unicode string (one or more
# code points joined) the name maps to.
_ADOBE_GLYPH_LIST: dict[str, str] = {
    'A': 'A',
    'AE': 'Æ',
    'AEacute': 'Ǽ',
    'AEmacron': 'Ǣ',
...
# Zapf Dingbats glyph list — 202 entries derived from upstream
# `.../glyphlist/zapfdingbats.txt`.
_ZAPF_DINGBATS_LIST: dict[str, str] = {
    'a100': '❞',
    'a101': '❡',
    'a102': '❢',
    'a103': '❣',
...
class GlyphList:
    """PostScript glyph list — maps glyph names to Unicode character sequences.

    Mirrors ``org.apache.pdfbox.pdmodel.font.encoding.GlyphList``. Two
    canonical instances are exposed as class attributes: :attr:`DEFAULT`
    ...
    def __init__(self, name_to_unicode: dict[str, str]) -> None:
        ...
        self._name_to_unicode: dict[str, str] = dict(name_to_unicode)
    ...
    def to_unicode(self, name: str | None) -> str | None:
        ...
        unicode = self._name_to_unicode.get(name)
...
GlyphList.ZAPF_DINGBATS = GlyphList(_ZAPF_DINGBATS_LIST)

...
class FDFAnnotationSquare(FDFAnnotation):
    """FDF square annotation — ``/Subtype /Square``.

    Mirrors ``org.apache.pdfbox.pdmodel.fdf.FDFAnnotationSquare``.
    """
    ...
    def init_fringe(self, fringe: str | None) -> None:
        ...
        Mirrors upstream ``initFringe(Element)`` (Java lines 82-91). Accepts

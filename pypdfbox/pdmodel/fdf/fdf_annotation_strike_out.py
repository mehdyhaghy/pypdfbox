...
class FDFAnnotationStrikeOut(FDFAnnotationTextMarkup):
    """FDF StrikeOut annotation — ``/Subtype /StrikeOut``.

    Mirrors ``org.apache.pdfbox.pdmodel.fdf.FDFAnnotationStrikeOut``. Extends
    :class:`FDFAnnotationTextMarkup`, which carries the ``/QuadPoints`` helper.
    """

    SUBTYPE: str = "StrikeOut"
...
__all__ = ["FDFAnnotationStrikeOut"]

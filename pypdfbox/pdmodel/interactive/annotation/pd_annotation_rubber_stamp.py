...
class PDAnnotationRubberStamp(PDAnnotation):
    ...
    icon is selected by ``/Name`` from the standard set below.
    """
    ...
    #: All 14 standard stamp icon names from PDF 32000-1:2008 Table 183 —
    #: the values a conforming reader is required to recognise. Matches
    #: :data:`PDAnnotationStamp.STANDARD_NAMES`.
    ...
    def is_standard_name(self) -> bool:
        ...
        ``Draft`` (the spec default when ``/Name`` is absent) is treated
        as standard.
        """

...
class PDSquareAppearanceHandler(PDAbstractAppearanceHandler):
    """Generate the appearance stream for a square annotation. Mirrors
    ...
    def generate_normal_appearance(self) -> None:
        ...
        (PDSquareAppearanceHandler.java:56)."""
    ...
    def get_line_width(self) -> float:
        ...
        (PDSquareAppearanceHandler.java:125)."""
        annotation = self.get_annotation()
    ...
    def _interior_components(annotation) -> list[float] | None:
        ...
        if interior is None:
            return None
        # Annotation may expose interior as COSArray, list, or tuple.
...
__all__ = ["PDSquareAppearanceHandler"]

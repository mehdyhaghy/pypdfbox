...
# Digital-signature / DocMDP permission-dictionary keys (PDF 32000-1 §12.8).
COSName.P = _static_name("P")  # type: ignore[attr-defined]
COSName.V = _static_name("V")  # type: ignore[attr-defined]
COSName.PERMS = _static_name("Perms")  # type: ignore[attr-defined]
COSName.DOCMDP = _static_name("DocMDP")  # type: ignore[attr-defined]
COSName.REFERENCE = _static_name("Reference")  # type: ignore[attr-defined]
COSName.SIG_REF = _static_name("SigRef")  # type: ignore[attr-defined]
COSName.TRANSFORM_METHOD = _static_name("TransformMethod")  # type: ignore[attr-defined]

...
from tests.rendering import test_pdf_renderer_wave471 as wave471


def test_wave471_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave471, "PDDocument", FakeDocument)

    doc, page = wave471._make_doc()  # noqa: SLF001

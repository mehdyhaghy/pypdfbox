...
from tests.rendering import test_pdf_renderer_wave481 as wave481


def test_wave481_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave481, "PDDocument", FakeDocument)

    doc, page = wave481._make_doc()  # noqa: SLF001

...
from tests.rendering import test_pdf_renderer_wave641 as wave641


def test_wave641_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave641, "PDDocument", FakeDocument)

    doc, page = wave641._make_doc()  # noqa: SLF001

...
from tests.rendering import test_pdf_renderer_wave501 as wave501


def test_wave501_make_doc_removes_existing_pages(monkeypatch) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave501, "PDDocument", FakeDocument)

    doc, page = wave501._make_doc(17.0, 19.0)  # noqa: SLF001

...
from tests.rendering import test_pdf_renderer_wave572 as wave572


def test_wave572_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave572, "PDDocument", FakeDocument)

    doc, page = wave572._make_doc(8.0, 10.0)  # noqa: SLF001

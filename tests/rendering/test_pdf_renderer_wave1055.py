...
from tests.rendering import test_pdf_renderer_wave581 as wave581


def test_wave581_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave581, "PDDocument", FakeDocument)

    doc, page = wave581._make_doc(7.0, 9.0)  # noqa: SLF001

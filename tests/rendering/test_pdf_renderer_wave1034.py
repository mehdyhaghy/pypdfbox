...
from tests.rendering import test_pdf_renderer_wave711 as wave711


def test_wave711_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave711, "PDDocument", FakeDocument)

    doc, page = wave711._make_doc(24.0, 36.0)  # noqa: SLF001

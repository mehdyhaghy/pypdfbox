...
import tests.rendering.test_pdf_renderer_knockout_isolation as knockout_tests
...
def test_knockout_make_doc_removes_preexisting_page(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(knockout_tests, "PDDocument", _DocWithExistingPage)

    doc, page = knockout_tests._make_doc()

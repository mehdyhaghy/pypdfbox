...
from tests.rendering import test_pdf_renderer_wave672 as wave672


def test_wave672_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave672, "PDDocument", FakeDocument)

    doc, page = wave672._make_doc()  # noqa: SLF001

...
import tests.rendering.test_pdf_renderer_accessors as accessor_tests
...
def test_accessor_make_doc_removes_preexisting_page(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(accessor_tests, "PDDocument", _DocWithExistingPage)

    doc, page = accessor_tests._make_doc()  # noqa: SLF001

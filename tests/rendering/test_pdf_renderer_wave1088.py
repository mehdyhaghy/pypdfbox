...
from tests.rendering import test_pdf_renderer_softmask_extgstate as smask_tests


def test_softmask_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(smask_tests, "PDDocument", FakeDocument)

    doc, page = smask_tests._make_doc(24.0, 36.0)  # noqa: SLF001

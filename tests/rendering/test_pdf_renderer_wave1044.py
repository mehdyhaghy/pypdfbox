...
from tests.rendering import test_pdf_renderer_wave642 as wave642
...
def test_wave642_make_doc_removes_existing_default_page(monkeypatch: Any) -> None:
    ...
    monkeypatch.setattr(wave642, "PDDocument", make_document)

    doc, page = wave642._make_doc(width=8.0, height=9.0)  # noqa: SLF001

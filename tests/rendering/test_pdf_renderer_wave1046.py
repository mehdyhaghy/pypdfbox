...
from tests.rendering import test_pdf_renderer_wave631 as wave631


def test_wave631_make_doc_removes_existing_pages(monkeypatch: Any) -> None:
    class FakeDocument:
    ...
    monkeypatch.setattr(wave631, "PDDocument", FakeDocument)

    doc, page = wave631._make_doc()  # noqa: SLF001

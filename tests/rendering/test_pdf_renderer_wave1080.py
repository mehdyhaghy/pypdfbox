...
import tests.rendering.test_pdf_renderer_wave392 as wave392
...
def test_make_doc_removes_preexisting_page_before_adding_fresh_page(
    ...
    monkeypatch.setattr(wave392, "PDDocument", _DocWithExistingPage)

    doc, page = wave392._make_doc(12.0, 13.0)  # noqa: SLF001

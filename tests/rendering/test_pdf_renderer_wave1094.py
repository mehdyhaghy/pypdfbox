...
def test_page_index_make_doc_removes_preexisting_page(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(page_index_tests, "PDDocument", _DocWithExistingPage)

    doc = page_index_tests._make_doc()  # noqa: SLF001

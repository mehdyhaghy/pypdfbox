...
def test_wave664_prepare_security_handler_accepts_bytes_password(
    ...
    handler = parser._prepare_security_handler_if_needed()
...
def test_wave664_resolve_document_id_rejects_empty_or_non_string_arrays() -> None:
    ...
    assert parser._resolve_document_id(trailer) is None
...
def test_wave664_load_compressed_object_header_number_mismatch_resolves_null() -> None:
    ...
    try:
        ...
        loaded = parser._load_compressed_object(7, 0, COSObject(8, 0))
